...
class RecorderTest {
    ...
    private final RecordingEventQueue callRecordQueue = new RecordingEventQueue(Settings.builder().build(), typeResolver, new AgentDataWriter(storage, methodRepository), new NullMetrics());
