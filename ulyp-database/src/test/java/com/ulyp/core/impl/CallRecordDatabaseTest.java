...
public abstract class CallRecordDatabaseTest {
    ...
    public void testRecordsSaving() throws DatabaseException {
        ...
        exitRecords.add(0, 100, typeResolver, false, ObjectBinaryPrinterType.IDENTITY_PRINTER.getInstance(), "asdasdad");
    ...
    public void testFieldsSavingWithTwoCallRecords() throws DatabaseException {
        ...
        exitRecords.add(1, 100, typeResolver, false, ObjectBinaryPrinterType.STRING_PRINTER.getInstance(), "zzzxzxzx");
        exitRecords.add(0, 100, typeResolver, false, ObjectBinaryPrinterType.IDENTITY_PRINTER.getInstance(), "asdasdad");
    ...
    public void testSavingAsWholeChunk() throws DatabaseException {
        ...
        exitRecords.add(2, 100, typeResolver, false, ObjectBinaryPrinterType.IDENTITY_PRINTER.getInstance(), "asdasdad");
        exitRecords.add(1, 100, typeResolver, false, ObjectBinaryPrinterType.IDENTITY_PRINTER.getInstance(), "asdasdad");
        exitRecords.add(0, 100, typeResolver, false, ObjectBinaryPrinterType.IDENTITY_PRINTER.getInstance(), "asdasdad");
