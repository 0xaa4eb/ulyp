...
| ulyp.record-collections | Records values (some items) of collections. Possible values are: `NONE`, `JDK` (only JDK collections), `ALL` (dangerous)                                                                                                                          | `-Dulyp.collections=JDK`                                                         | `NONE`       |
